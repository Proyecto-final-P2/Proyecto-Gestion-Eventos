...
public class Util {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/salonDeEventos?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true&characterEncoding=UTF-8";
